...
function call(id) {
  ...
  const inCall = document.getElementById(`user${id}`);
  const buttonInCall = inCall.querySelector('button')
  buttonInCall.setAttribute("disabled", "disabled")
  buttonInCall.innerHTML = "Em Atendimento"
